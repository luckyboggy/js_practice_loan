...
/* harmony import */ var _modules_slider_sliderMain_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/slider/sliderMain.js */ "./src/js/modules/slider/sliderMain.js");
...
/* harmony import */ var _modules_playVideo_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/playVideo.js */ "./src/js/modules/playVideo.js");
/* harmony import */ var _modules_difference_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/difference.js */ "./src/js/modules/difference.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var sliderMain = new _modules_slider_sliderMain_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
    container: '.page',
    btns: '.next'
  });
  sliderMain.render();
  var modulePageSlider = new _modules_slider_sliderMain_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
    container: '.moduleapp',
    btns: '.next'
  });
  modulePageSlider.render();
  var showUpSlider = new _modules_slider_sliderMini_js__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  showUpSlider.init();
  var modulesSlider = new _modules_slider_sliderMini_js__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  modulesSlider.init();
  var feedSlider = new _modules_slider_sliderMini_js__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  feedSlider.init();
  new _modules_difference_js__WEBPACK_IMPORTED_MODULE_4__["default"]('.officerold', '.officernew', '.officer__card-item').init();
  new _modules_forms_js__WEBPACK_IMPORTED_MODULE_5__["default"]('.form').init();
  var videoPlayer = new _modules_playVideo_js__WEBPACK_IMPORTED_MODULE_3__["default"]('.showup .play', '.overlay');
  videoPlayer.init();
});
...
function (_Slider) {
  ...
  _createClass(SliderMain, [{
    ...
    value: function showSlides(n) {
      ...
      if (n < 1) {
        this.slideIndex = this.slides.tength;
      }
...
function (_Slider) {
  ...
  function SliderMini(conteiner, next, prev, activeClass, animate, autoplay) {
    _classCallCheck(this, SliderMini);

    return _possibleConstructorReturn(this, _getPrototypeOf(SliderMini).call(this, conteiner, next, prev, activeClass, animate, autoplay));
  }

  _createClass(SliderMini, [{
    key: "decorazeSlide",
    value: function decorazeSlide() {
      var _this = this;
      ...
      this.prev.addEventListener('click', function () {
        for (var i = _this2.slides.length - 1; i > 0; i--) {
          if (_this2.slides[i].tagName !== 'BUTTON') {
            var activeSlide = _this2.slides[i]; // Переносит последний элемент псевдомассива перед первым элементом

            _this2.container.insertBefore(activeSlide, _this2.slides[0]);

            _this2.decorazeSlide();
